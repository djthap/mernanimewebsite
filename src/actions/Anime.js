...
export async function getRecentAnime(){
    ...
    try
    {
        const response = await axios.get(`${Theme.url}/meta/anilist/recent-episodes`,  {
            headers: {
            'Content-Type': 'application/json',
            page: 1,
            perPage: 20,
...
export async function getRandom(){
    ...
    try
    {
        const response = await axios.get(`${Theme.url}/meta/anilist/random-anime`,  {
            headers: {
            'Content-Type': 'application/json',
            page: 1,
            perPage: 20,
...
export async function getAiring(){
    ...
    try
    {
        const response = await axios.get(`${Theme.url}/meta/anilist/airing-schedule`,  {
            headers: {
            'Content-Type': 'application/json',
            page: 1,
            perPage: 20,
